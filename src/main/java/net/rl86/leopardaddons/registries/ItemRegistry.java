...
import net.rl86.leopardaddons.content.RemotePeripheralItem;
...
public class ItemRegistry {
	...
	public static final DeferredHolder<Item, BlockItem> remotePeripheral = registry.register("remote_peripheral", RemotePeripheralItem::new);
